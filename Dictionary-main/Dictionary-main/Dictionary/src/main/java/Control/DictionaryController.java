...
public class DictionaryController extends DatabaseController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        searchButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                switchComponent("D:\\BTL-OOP\\Dictionary-main\\Dictionary-main\\Dictionary\\src\\main\\resources\\Commandline\\SearchGui.fxml");
            }
        });
        ...
        addWordButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent mouseEvent) {
                switchComponent("D:\\BTL-OOP\\Dictionary-main\\Dictionary-main\\Dictionary\\src\\main\\resources\\Commandline\\AddGui.fxml");
            }
        });
        ...
        myWordButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                switchComponent("D:\\BTL-OOP\\Dictionary-main\\Dictionary-main\\Dictionary\\src\\main\\resources\\Commandline\\MyWordGui.fxml");
            }
        });
        ...
        googleTranslateButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent event) {
                switchComponent("D:\\BTL-OOP\\Dictionary-main\\Dictionary-main\\Dictionary\\src\\main\\resources\\Commandline\\GoogleTranslateGui.fxml");
            }
        });
    ...
    public void switchtoStudy() throws IOException {
        URL url = new File("D:\\BTL-OOP\\Dictionary-main\\Dictionary-main\\Dictionary\\src\\main\\resources\\Commandline\\StudyGui.fxml").toURI().toURL();
    ...
    public void switchtoDictionaryMain() throws IOException {
        URL url = new File("D:\\BTL-OOP\\Dictionary-main\\Dictionary-main\\Dictionary\\src\\main\\resources\\Commandline\\DictionaryGui.fxml").toURI().toURL();
        Parent root = FXMLLoader.load(url);
        Scene scene = new Scene(root, 1030, 679);
        Main.stageRefer.setScene(scene);
        Main.moveScreen(root, Main.stageRefer);
    ...
    public void switchtoGameMenu() throws IOException {
        URL url = new File("D:\\BTL-OOP\\Dictionary-main\\Dictionary-main\\Dictionary\\src\\main\\resources\\Commandline\\MenuGame.fxml").toURI().toURL();
        Parent root = FXMLLoader.load(url);
        Scene scene = new Scene(root, 1030, 679);
        Main.stageRefer.setScene(scene);
        Main.moveScreen(root, Main.stageRefer);
    ...
    public void switchtoGuessGame() throws IOException {
        URL url = new File("D:\\BTL-OOP\\Dictionary-main\\Dictionary-main\\Dictionary\\src\\main\\resources\\Commandline\\GuessWordGame.fxml").toURI().toURL();
        Parent root = FXMLLoader.load(url);
        Scene scene = new Scene(root, 1030, 679);
        Main.stageRefer.setScene(scene);
        Main.moveScreen(root, Main.stageRefer);
    ...
    public void switchtoHangmanGame() throws IOException {
        URL url = new File("D:\\BTL-OOP\\Dictionary-main\\Dictionary-main\\Dictionary\\src\\main\\resources\\Commandline\\HangMan.fxml").toURI().toURL();
        Parent root = FXMLLoader.load(url);
